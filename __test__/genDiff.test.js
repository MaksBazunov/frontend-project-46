...
test.each([['filepath1.json', 'filepath2.json', 'stylishFile.txt'],
  ...
  ['file1.yml', 'filepath2.json', 'stylishFile.txt']])(
    'diff format stylish', (filepath1, filepath2, expected) => {
...
test.each([['filepath1.json', 'filepath2.json', 'plainFile.txt'],
  ...
  ['file1.yml', 'filepath2.json', 'plainFile.txt']])(
    'diff format plain', (filepath1, filepath2, expected) => {
...
test.each([['filepath1.json', 'filepath2.json', 'jsonFile.txt'],
  ...
  ['file1.yml','filepath2.json','jsonFile.txt'],])(
    'diff format json', (filepath1, filepath2, expected) => {
